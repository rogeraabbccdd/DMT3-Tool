...
export default {
  ...
  computed: {
    ...
    to () {
      ...
      return (mode + parseInt(this.num)) * 54 - (6 - this.page) * 9 - 1
    },
    from () {
      return this.to - 8
    },
  ...
  methods: {
    ...
    saveSlot () {
      this.axios.post('http://localhost:1027/saveSlot', { slot: this.dialog, mode: this.mode, num: this.num, page: this.page })
        .then((res) => {
